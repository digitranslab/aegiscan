...
const constructDslLang = (): {
  ...
  const aegiscanDslLang: languages.IMonarchLanguage = {
    tokenizer: {
      root: [
        // Keywords first
        [
  ...
  return { conf: yamlConf, lang: aegiscanDslLang }
}
...
function registerProviders(
  ...
  monaco.languages.register({ id: "aegiscan-dsl" })
  const { conf, lang } = constructDslLang()
  monaco.languages.setLanguageConfiguration("aegiscan-dsl", conf)
