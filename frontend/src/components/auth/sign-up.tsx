...
import AegiscanIcon from "public/icon.png"
import { useForm } from "react-hook-form"
import { z } from "zod"

import { RequestValidationError, AegiscanApiError } from "@/lib/errors"
    ...
    >
      <div className="flex w-full flex-1 flex-col justify-center gap-2 px-8 sm:max-w-md">
        <CardHeader className="items-center space-y-2 text-center">
          <Image src={AegiscanIcon} alt="Aegiscan" className="mb-8 size-16" />
