...
export const $TableColumnCreate = {
  properties: {
    ...
    type: {
      allOf: [
        {
          $ref: "#/components/schemas/aegiscan__tables__enums__SqlType__1",
        },
      ],
      maxLength: 100,
      minLength: 1,
...
export const $aegiscan__tables__enums__SqlType__1 = {
  type: "string",
  enum: [
    "TEXT",
    "VARCHAR",
...
export const $aegiscan__tables__enums__SqlType__2 = {
  $ref: "#/components/schemas/aegiscan__tables__enums__SqlType__1",
  minLength: 1,
} as const
