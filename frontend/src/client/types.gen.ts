...
export type TableColumnCreate = {
   ...
   */
  type: aegiscan__tables__enums__SqlType__1
  nullable?: boolean
  default?: unknown | null
}
...
export type TableColumnUpdate = {
   ...
   * The SQL type of the column
   */
  type?: aegiscan__tables__enums__SqlType__1 | null
  /**
 ...
 * Supported SQL types.
 */
export type aegiscan__tables__enums__SqlType__1 =
  | "TEXT"
  | "VARCHAR"
  | "INTEGER"
  | "BIGINT"
...
export type aegiscan__tables__enums__SqlType__2 =
  aegiscan__tables__enums__SqlType__1
