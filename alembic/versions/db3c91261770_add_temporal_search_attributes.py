...
async def add_temporal_search_attributes():
    ...
    await client.operator_service.add_search_attributes(
        AddSearchAttributesRequest(
            search_attributes={
                "AegiscanTriggerType": IndexedValueType.INDEXED_VALUE_TYPE_KEYWORD,
                "AegiscanTriggeredByUserId": IndexedValueType.INDEXED_VALUE_TYPE_KEYWORD,
            },
...
async def remove_temporal_search_attributes():
    ...
    await client.operator_service.remove_search_attributes(
        RemoveSearchAttributesRequest(
            search_attributes=["AegiscanTriggerType", "AegiscanTriggeredByUserId"],
            namespace=TEMPORAL__CLUSTER_NAMESPACE,
        )
    )
...
def upgrade() -> None:
    ...
    if TEMPORAL__API_KEY__ARN or TEMPORAL__API_KEY:
        logger.warning(
            ...
            " Please add search attributes (AegiscanTriggerType, AegiscanTriggeredByUserId) "
...
def downgrade() -> None:
    ...
    if TEMPORAL__API_KEY__ARN or TEMPORAL__API_KEY:
        logger.warning(
            ...
            " Please remove search attributes (AegiscanTriggerType, AegiscanTriggeredByUserId) "
            "through the cloud UI or `tcld`."
        )
    else:
