...
**Provide logs**
If applicable, please provide logs from the relevant Aegiscan container (`api`, `worker`, `executor`, `ui`) or browser console (e.g. `Chrome DevTools`).
...
- Aegiscan version (e.g. `0.27.3`)
- OS (e.g. Ubuntu 20.03 on WSL2)
- Where did you deploy Aegiscan? (VM, AWS EC2, etc.)
- CPU architecture
