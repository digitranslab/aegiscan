...
from aegiscan.db.schemas import Table
...
from aegiscan.types.exceptions import AegiscanNotFoundError
...
class TestTablesService:
    ...
    async def test_delete_table(self, tables_service: TablesService) -> None:
        ...
        # Attempt to retrieve the table; should raise AegiscanNotFoundError
        with pytest.raises(AegiscanNotFoundError):
...
class TestTableColumns:
    ...
    async def test_delete_column(self, tables_service: TablesService) -> None:
        ...
        # Attempt to retrieve the deleted column; should raise AegiscanNotFoundError
        with pytest.raises(AegiscanNotFoundError):
...
class TestTableRows:
    ...
    async def test_delete_row(
        ...
        # Attempt to retrieve the deleted row; should raise AegiscanNotFoundError
        with pytest.raises(AegiscanNotFoundError):
