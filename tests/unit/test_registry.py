...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Private GitLab
        (
            "git+ssh://git@internal.aegiscan/org/repo",
            GitUrl(
                host="internal.aegiscan",
                org="org",
                repo="repo",
                ref=None,
            ),
        ...
        # (
        #     "git+ssh://git@internal.aegiscan/org/group/repo",
        #     GitUrl(
        #         host="internal.aegiscan",
        #         org="org/group",
        #         repo="repo",
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "git+ssh://git@digi-trans.org/aegiscan-dev/aegiscan-registry.git@v1.0.0",
            id="Invalid host domain aegiscan.com",
        ),
        pytest.param(
            "git+ssh://git@git.com/aegiscan-dev/aegiscan-registry.git@v1.0.0",
