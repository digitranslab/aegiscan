...
from aegiscan.settings.constants import SENSITIVE_SETTINGS_KEYS
...
from aegiscan.settings.router import check_other_auth_enabled
from aegiscan.settings.service import SettingsService, get_setting, get_setting_override
...
def test_get_setting_override(
    ...
    if expected is not None:
        monkeypatch.setenv(f"AEGISCAN__SETTING_OVERRIDE_{key.upper()}", env_value)
