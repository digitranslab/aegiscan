...
from aegiscan.identifiers.common import (
    AegiscanUUID,
    id_from_short,
    id_to_short,
)
...
class MockUUID(AegiscanUUID[str]):
    """Test implementation of AegiscanUUID."""
...
class TestAegiscanUUID:
    """Test suite for AegiscanUUID base class."""

    def test_missing_prefix(self) -> None:
        """Test that AegiscanUUID requires a prefix."""

        class InvalidUUID(AegiscanUUID):
            pass
    ...
    def test_equality(self) -> None:
        """Test that AegiscanUUID instances can be compared using ==."""
    ...
    def test_equality_with_normal_uuid(self) -> None:
        """Test that AegiscanUUID instances can be compared with normal UUIDs."""
...
def test_aegiscan_uuid_serialization(test_uuid_str):
    """Test that AegiscanUUID can be serialized and deserialized correctly."""
...
def test_aegiscan_uuid_construction(test_uuid_str):
    """Test that AegiscanUUID can be constructed from various inputs."""
    original_uuid = UUID(test_uuid_str)
    test_uuid = MockUUID.from_uuid(original_uuid)
