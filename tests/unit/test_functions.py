...
from aegiscan.expressions.functions import (
    _bool,
    add,
    add_prefix,
    add_suffix,
...
@pytest.mark.parametrize(
    "input_str,expected",
    [
        ("admin+aegiscan1@gmail.com", "admin%2Baegiscan1%40gmail.com"),
        ("admin+aegiscan1-org@gmail.com", "admin%2Baegiscan1-org%40gmail.com"),
    ],
)
...
@pytest.mark.parametrize(
    "input_str,expected",
    [
        ("admin%2Baegiscan1%40gmail.com", "admin+aegiscan1@gmail.com"),
        ("admin%2Baegiscan1-org%40gmail.com", "admin+aegiscan1-org@gmail.com"),
    ],
)
