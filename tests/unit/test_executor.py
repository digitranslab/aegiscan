...
from aegiscan.dsl.common import create_default_execution_context
...
from aegiscan.types.exceptions import ExecutionError, LoopExecutionError
...
def test_sync_executor_entrypoint(
    ...
    monkeypatch.setattr("aegiscan.executor.service.run_action_from_input", mock_action)
...
def test_sync_executor_entrypoint_returns_wrapped_error(
    ...
    monkeypatch.setattr("aegiscan.executor.service.run_action_from_input", mock_error)
...
async def test_dispatcher(
    ...
    monkeypatch.setattr(
        "aegiscan.executor.service.run_action_on_ray_cluster",
