...
from aegiscan_registry._internal.constants import DEFAULT_NAMESPACE
...
def register(
    *,
    ...
    This method creates a decorator that can be used to register a function as a UDF in the Aegiscan system.
    ...
    def decorator_register(fn: Callable[P, R]) -> Callable[P, R]:
        ...
        setattr(fn, "__aegiscan_udf", True)
        setattr(fn, "__aegiscan_udf_key", key)
        setattr(
            fn,
            "__aegiscan_udf_kwargs",
            {
