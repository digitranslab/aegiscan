...
import nh3
from aegiscan.config import AEGISCAN__ALLOWED_EMAIL_ATTRIBUTES
from typing_extensions import Doc

from aegiscan_registry import RegistrySecret, registry, secrets
...
def _build_email_message(
    ...
    if content_type == "text/html":
        ...
        if AEGISCAN__ALLOWED_EMAIL_ATTRIBUTES:
