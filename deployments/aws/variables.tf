...
variable "aws_account_id" {
  type        = string
  description = "(Optional) Account ID to deploy Aegiscan into. Only required if deploying cross-account."
  default     = null
}

variable "aws_role_name" {
  type        = string
  description = "(Optional) AWS role name for Terraform to assume to deploy Aegiscan. Only required if deploying cross-account."
  default     = null
}
...
variable "domain_name" {
  type        = string
  description = "The domain name to use for Aegiscan"
}
...
variable "aegiscan_image" {
  type    = string
  default = "ghcr.io/digitranslab/aegiscan"
}

variable "aegiscan_ui_image" {
  type    = string
  default = "ghcr.io/digitranslab/aegiscan-ui"
}

variable "aegiscan_image_tag" {
  type    = string
  default = "0.27.3"
}
...
variable "force_new_deployment" {
  type        = bool
  description = "Force a new deployment of Aegiscan services. Used to update services with new images."
  default     = false
}
...
variable "aegiscan_app_env" {
  type        = string
  description = "The environment of the Aegiscan application"
  default     = "production"
}
...
variable "aegiscan_db_encryption_key_arn" {
  type        = string
  description = "The ARN of the secret containing the Aegiscan database encryption key"
}

variable "aegiscan_service_key_arn" {
  type        = string
  description = "The ARN of the secret containing the Aegiscan service key"
}

variable "aegiscan_signing_secret_arn" {
  type        = string
  description = "The ARN of the secret containing the Aegiscan signing secret"
}
