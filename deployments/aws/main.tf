...
module "ecs" {
  ...
  # Aegiscan version
  aegiscan_image                           = var.aegiscan_image
  aegiscan_ui_image                        = var.aegiscan_ui_image
  aegiscan_image_tag                       = var.aegiscan_image_tag
  ...
  aegiscan_app_env   = var.aegiscan_app_env
  ...
  aegiscan_db_encryption_key_arn = var.aegiscan_db_encryption_key_arn
  aegiscan_service_key_arn       = var.aegiscan_service_key_arn
  aegiscan_signing_secret_arn    = var.aegiscan_signing_secret_arn
