...
from aegiscan.expressions.expectations import ExpectedField, create_expectation_model
from aegiscan.logger import logger
from aegiscan.registry.actions.enums import TemplateActionValidationErrorType
...
class TemplateActionDefinition(BaseModel):
    ...
    def validate_steps(self):
        ...
        if not self.steps:
            raise AegiscanValidationError("Template action must have at least 1 step")
...
class RegistryActionValidateResponse(BaseModel):
    ...
    @staticmethod
    def from_dsl_validation_error(exc: AegiscanValidationError):
        return RegistryActionValidateResponse(
