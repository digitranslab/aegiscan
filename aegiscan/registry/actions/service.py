...
from aegiscan.db.schemas import RegistryAction, RegistryRepository
from aegiscan.expressions.eval import extract_expressions
...
from aegiscan.registry.actions.enums import (
...
from aegiscan.registry.loaders import LoaderMode, get_bound_action_impl
from aegiscan.registry.repository import Repository
from aegiscan.service import BaseService
from aegiscan.settings.service import get_setting_cached
...
class RegistryActionsService(BaseService):
    ...
    async def get_action(self, action_name: str) -> RegistryAction:
        ...
        statement = select(RegistryAction).where(
            RegistryAction.owner_id == config.AEGISCAN__DEFAULT_ORG_ID,
    ...
    async def create_action(
        ...
        owner_id: UUID4 = config.AEGISCAN__DEFAULT_ORG_ID,
    ) -> RegistryAction:
        """
    ...
    async def upsert_actions_from_repo(
        ...
        # Perform diffing here. The expectation for this endpoint is to sync Aegiscan's view of
