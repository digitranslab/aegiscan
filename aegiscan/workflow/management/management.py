...
from aegiscan.db.schemas import Action, Tag, Webhook, Workflow, WorkflowTag
from aegiscan.dsl.common import DSLEntrypoint, DSLInput, build_action_statements
from aegiscan.dsl.models import DSLConfig
from aegiscan.dsl.view import RFGraph
from aegiscan.identifiers import WorkflowID
from aegiscan.identifiers.workflow import (
    LEGACY_WF_ID_PATTERN,
    WF_ID_SHORT_PATTERN,
    WorkflowUUID,
)
from aegiscan.registry.actions.models import RegistryActionValidateResponse
from aegiscan.service import BaseService
from aegiscan.types.exceptions import (
    AegiscanAuthorizationError,
    AegiscanValidationError,
)
from aegiscan.validation.service import validate_dsl
from aegiscan.workflow.actions.models import ActionControlFlow
...
class WorkflowsManagementService(BaseService):
    ...
    async def create_workflow_from_dsl(
        ...
        """Create a new workflow from a Aegiscan DSL data object."""
        ...
        except* AegiscanValidationError as eg:
