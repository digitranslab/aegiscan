...
from aegiscan.dsl.common import DSLInput, DSLRunArgs
from aegiscan.dsl.models import TriggerInputs
from aegiscan.dsl.validation import validate_trigger_inputs
from aegiscan.dsl.workflow import DSLWorkflow, retry_policies
from aegiscan.identifiers import UserID
...
from aegiscan.types.exceptions import AegiscanServiceError, AegiscanValidationError
from aegiscan.workflow.executions.common import (
...
from aegiscan.workflow.executions.enums import (
    TemporalSearchAttr,
    TriggerType,
    WorkflowEventType,
)
    ...
    async def get_execution(
        ...
        if _include_legacy:
            ...
            try:
                ...
                raise AegiscanServiceError("Invalid workflow execution ID") from e
