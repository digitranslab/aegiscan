...
from aegiscan.auth.enums import SpecialUserID
from aegiscan.db.dependencies import AsyncDBSession
from aegiscan.db.schemas import WorkflowDefinition
from aegiscan.dsl.common import DSLInput
from aegiscan.identifiers import UserID
from aegiscan.identifiers.workflow import OptionalAnyWorkflowIDQuery, WorkflowUUID
from aegiscan.logger import logger
from aegiscan.types.exceptions import AegiscanValidationError
from aegiscan.workflow.executions.dependencies import UnquotedExecutionID
...
async def create_workflow_execution(
    ...
    try:
        ...
        return response
    except AegiscanValidationError as e:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail={
                "type": "AegiscanValidationError",
                "message": str(e),
                "detail": e.detail,
            },
        ) from e
