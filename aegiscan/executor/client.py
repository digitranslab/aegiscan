...
from aegiscan.clients import AuthenticatedServiceClient
from aegiscan.contexts import ctx_role
from aegiscan.dsl.models import RunActionInput
...
class ExecutorHTTPClient(AuthenticatedServiceClient):
    ...
    def __init__(self, role: Role | None = None, *args: Any, **kwargs: Any) -> None:
        self._executor_base_url = config.AEGISCAN__EXECUTOR_URL
...
class ExecutorClient:
    ...
    _timeout: float = config.AEGISCAN__EXECUTOR_CLIENT_TIMEOUT
