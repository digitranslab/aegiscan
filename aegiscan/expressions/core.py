...
from aegiscan.expressions.common import ExprContext, ExprOperand, ExprType
from aegiscan.expressions.parser.core import parser
from aegiscan.expressions.parser.evaluator import ExprEvaluator
from aegiscan.expressions.parser.validator import BaseExprValidator
from aegiscan.logger import logger
from aegiscan.parse import traverse_expressions
...
class Expression:
    ...
    def __call__(self) -> Any:
        match self._visitor:
            ...
            case _:
                raise AegiscanExpressionError(f"Unsupported visitor: {self._visitor}")
