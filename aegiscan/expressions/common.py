...
class AegiscanEnum(StrEnum):
    def __repr__(self) -> str:
        return str(self)


class ExprContext(AegiscanEnum):
    """Expression contexts."""
...
def eval_jsonpath(
    ...
    *,
    ...
    try:
        ...
        raise AegiscanExpressionError(f"Invalid jsonpath {formatted_expr!r}") from e
