...
from aegiscan.dsl.action import DSLActivities
from aegiscan.dsl.client import get_temporal_client
from aegiscan.dsl.validation import validate_trigger_inputs_activity
from aegiscan.dsl.workflow import DSLWorkflow
...
async def main() -> None:
    ...
    async with Worker(
        client,
        task_queue=os.environ.get("TEMPORAL__CLUSTER_QUEUE", "aegiscan-task-queue"),
