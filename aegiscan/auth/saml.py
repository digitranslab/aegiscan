...
from aegiscan.auth.users import AuthBackendStrategyDep, UserManagerDep, auth_backend
from aegiscan.config import (
    SAML_IDP_METADATA_URL,
    SAML_PUBLIC_ACS_URL,
    AEGISCAN__PUBLIC_API_URL,
    XMLSEC_BINARY_PATH,
)
...
async def create_saml_client() -> Saml2Client:
    ...
    saml_settings = {
        ...
        "entityid": AEGISCAN__PUBLIC_API_URL,
        "xmlsec_binary": XMLSEC_BINARY_PATH,
        # Service provider settings
        "service": {
            "sp": {
                "name": "aegiscan_saml_sp",
                "description": "Aegiscan SAML SSO Service Provider",
                "endpoints": {
