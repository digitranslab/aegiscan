...
from aegiscan.tables.importer import CSVImporter
...
from aegiscan.types.exceptions import AegiscanImportError, AegiscanNotFoundError
...
async def import_csv(
    ...
    try:
        ...
        await importer.process_chunk(current_chunk, service, table)
    except AegiscanImportError as e:
