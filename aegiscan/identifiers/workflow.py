...
from aegiscan.identifiers.common import AegiscanUUID
from aegiscan.identifiers.resource import ResourcePrefix, generate_resource_id
from aegiscan.identifiers.schedules import SCHEDULE_EXEC_ID_PATTERN
...
class WorkflowUUID(AegiscanUUID[WorkflowIDShort]):
...
class ExecutionUUID(AegiscanUUID[ExecutionIDShort]):
...
class WorkspaceUUID(AegiscanUUID[WorkspaceIDShort]):
