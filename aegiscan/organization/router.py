...
from aegiscan.organization.models import OrgMemberRead, OrgRead
from aegiscan.organization.service import OrgService
...
async def delete_org_member(
    *,
    ...
    except AegiscanAuthorizationError as e:
        raise HTTPException(
