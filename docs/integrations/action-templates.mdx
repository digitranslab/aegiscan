...
**Action Templates** provide a secure way to retrieve OAuth 2.0 tokens without exposing the secret in Aegiscan logs.
...
<Tip>
  ...
  Check out Aegiscan's [Wiz](https://github.com/DigitransLab/aegiscan/blob/main/registry/aegiscan_registry/integrations/wiz.py),
  [Microsoft Graph](https://github.com/DigitransLab/aegiscan/blob/main/registry/aegiscan_registry/integrations/microsoft_graph.py),
  and [Jamf](https://github.com/DigitransLab/aegiscan/blob/main/registry/aegiscan_registry/integrations/jamf.py) `get_access_token`
