...
<Note>
  ...
  check out Aegiscan [inline functions](/quickstart/expressions#fn-context).
</Note>

Data transforms allow you to filter, reshape, and manipulate data within your workflows.
Aegiscan supports the following transform actions:
...
It is also one of the most powerful transform actions in Aegiscan.
...
<Warning>
  ...
  If you want to use custom Python code in Aegiscan,
  we recommend syncing these functions into Aegiscan as [Python UDF actions](/integrations/python-udfs).
