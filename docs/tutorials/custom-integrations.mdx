...
description: Build and sync custom integrations from a private Git repository into Aegiscan.
icon: github
---
...
<Tip>
  Get started by cloning the [custom-integrations-starter-kit](https://github.com/DigitransLab/custom-integrations-starter-kit) template repo.
</Tip>

<Note>
  Git sync is the recommended way to sync custom integrations into Aegiscan in production.
  For development,
</Note>

By the end of this tutorial, you'll learn how to:

- Sync custom integrations into Aegiscan
...
In this section, we'll walk through the process of securely syncing custom integrations into Aegiscan.
...
<Steps>
  ...
  <Step title="Private key in Aegiscan">
  ...
  <Step title="Refresh repos in Aegiscan">
  ...
  <Step title="Sync custom repo">
    ...
    Your custom integrations should now be visible in your Aegiscan instance's registry.
  </Step>
  ...
  <Step title="🎉 That's it!">
    ...
    Just push to your changes to the git repo and press sync in Aegiscan Registry.
...
<Tip>
  ...
  Check out Aegiscan's open source [Action Templates](https://github.com/DigitransLab/aegiscan/tree/main/registry/aegiscan_registry/templates) on GitHub for examples.
...
<Tip>
  Check out Aegiscan's open source [core actions](https://github.com/DigitransLab/aegiscan/tree/main/registry/aegiscan_registry/core)
  and [Python integrations](https://github.com/DigitransLab/aegiscan/tree/main/registry/aegiscan_registry/integrations) on GitHub for examples.
</Tip>
...
- Join our [Discord community](https://discord.gg/n3GF4qxFU8) and meet other Aegiscan users and contributors.
- Have integrations you'd like to share with the community? Open up an [issue](https://github.com/DigitransLab/aegiscan/issues) on GitHub and start contributing to open source!
