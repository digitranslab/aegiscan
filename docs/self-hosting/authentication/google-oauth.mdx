---
title: Google OAuth
description: Learn how to authenticate into Aegiscan using Google OAuth.
icon: google
---
...
```bash
AEGISCAN__AUTH_TYPES=google_oauth
AEGISCAN__SETTING_OVERRIDE_OAUTH_GOOGLE_ENABLED=true
```
...
<Steps>
  <Step title="Set up OAuth consent screen in Google">
    ...
    1. Create a new app.
    2. Set **Authorized JavaScript origins** to the domain you're serving Aegiscan from.
  ...
  <Step title="Configure environment variables in Aegiscan">
