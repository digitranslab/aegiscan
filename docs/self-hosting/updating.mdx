...
You will need to manually sync the `aegiscan_registry` repository from the **Registry** page:
...
To update Aegiscan, update the Terraform variable `aegiscan_image_tag` to the latest version and run `terraform apply`.
