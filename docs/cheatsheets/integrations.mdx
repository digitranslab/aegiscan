---
title: Integrations
description: A cheatsheet of core actions, integrations, and credentials supported by Aegiscan.
---
...
<Note>
Aegiscan uses secret keys associated with each integration for 3rd-party authentication.
Find out more about how secrets work in Aegiscan [here](/quickstart/secrets).
</Note>
